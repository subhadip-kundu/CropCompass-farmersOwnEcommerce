  ...
  return (
    <div className="relative hover:scale-105 cursor-pointer">
      <div onClick={onClick} className="block w-full h-full">
        <div
          className="bg-cover bg-no-repeat rounded-lg overflow-hidden hover:shadow-xl"
          style={{ backgroundImage, width: "100%", height: "100%" }}
        >
          <div className="absolute inset-0 bg-black opacity-30 rounded-lg"></div>
          <p className="absolute bottom-0 left-0 px-4 py-2 font-medium text-white text-lg z-10">
            {categoryName}
          </p>
        </div>
      </div>
...
function FoodGrid() {
  ...
  return (
    <div className="flex flex-col w-full font-Rubik h-screen ">
      <div className="rounded-lg px-4 flex items-center justify-center text-[2.5rem] py-8 w-full">
        <p className="font-medium text-6xl text-cyan-900 ">Categories</p>
      </div>
